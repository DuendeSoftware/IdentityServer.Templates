...
[assembly: SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = "No need to change migrations, as they are generated code", Scope = "namespaceanddescendants", Target = "~N:IdentityServerEntityFramework.Migrations")]
...
[assembly: SuppressMessage("Naming", "CA1724:Type names should not match namespaces", Justification = "Namespaces of migrations are not likely to be used elsewhere, so there is little chance of confusion", Scope = "type", Target = "~T:IdentityServerEntityFramework.Migrations.ConfigurationDb.Configuration")]
[assembly: SuppressMessage("Naming", "CA1724:Type names should not match namespaces", Justification = "Namespaces of migrations are not likely to be used elsewhere, so there is little chance of confusion", Scope = "type", Target = "~T:IdentityServerEntityFramework.Migrations.PersistedGrantDb.Grants")]
